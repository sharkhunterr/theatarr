...
from theatarr.api import auth, config, display, feedback, logs, movies, portal, prerolls, quiz, services, sessions, sequences, sounds, templates, trailers, users, vote, wallmount
...
app.include_router(sounds.router, prefix="/api/v1")
app.include_router(prerolls.router, prefix="/api/v1")
