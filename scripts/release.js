#!/usr/bin/env node
/**
 * Flexible release script for Theatarr
 *
 * Features:
...
// Main release flow
async function main() {
  console.log('🚀 Theatarr Release Script\n');
  ...
  if (!options.skipRelease) {
    ...
    const releaseNotesFile = '/tmp/theatarr-release-notes.md';
    ...
    if (options.github) {
      ...
      const githubRepo = process.env.GITHUB_REPO || 'sharkhunterr/theatarr';
